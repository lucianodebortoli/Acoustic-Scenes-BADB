...
# main execution:
parser = argparse.ArgumentParser(description="Predict Audio Scene")
parser.add_argument("audio_path",type=str,help="Path to audio file for aplying scene classifier")
args = parser.parse_args()
tflite_predict_audio(audio_path=args.audio_path,model_path="CNN.tflite",labels_path="labels.txt")